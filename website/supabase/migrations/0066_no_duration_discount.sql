-- 0066: remove the multi-hour discount. A longer booking simply costs (and uses) 1 credit per
-- hour at the normal rate — no 5/8/10% reduction. Body identical to 0055's create_booking except
-- v_factor is now always 1, so price = base × hours and the credit debit is exactly v_hours.
