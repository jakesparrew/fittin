...
-- A coach can book a slot WITHOUT a client (p_client null) → the slot is reserved by the coach
-- (user_id = the coach) and a client can be assigned later. Same checks otherwise (recreated from 0084).
