...
export default function ComingSoon({ title = "Binnenkort beschikbaar", subtitle, icon = "📅" }) {
  return (
    <div className="px-8 py-16">
      <div className="mx-auto max-w-xl rounded-3xl border border-dashed border-borderc bg-surface p-10 text-center">
        ...
        <p className="mt-3 text-ink/60">{subtitle || "We werken aan deze functie — binnenkort beschikbaar."}</p>
