...
const groups = [
  { items: [{ href: "/beheer", label: "Dashboard", icon: "▦" }, { href: "/beheer/analytics", label: "Analytics", icon: "▰" }, { href: "/beheer/notificaties", label: "Notificaties", icon: "🔔" }, { href: "/beheer/inbox", label: "Inbox", icon: "✉" }] },
  { title: "Gym", items: [
