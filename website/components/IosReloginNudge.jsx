    ...
    <div className="fixed inset-x-0 bottom-0 z-[60] p-3" role="dialog" aria-label="Opnieuw inloggen">
      <div className="mx-auto flex max-w-md items-center gap-3 rounded-2xl border border-borderc bg-surface p-3 shadow-xl shadow-brand/10">
        ...
        <div className="min-w-0 flex-1">
          <p className="text-sm font-black text-ink">Welkom in de Fittin&rsquo;-app</p>
          <p className="mt-0.5 text-xs leading-snug text-ink/60">Log één keer opnieuw in — daarna blijf je ingelogd in de app.</p>
        </div>
