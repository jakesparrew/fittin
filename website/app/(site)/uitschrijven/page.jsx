    ...
    <main className="bg-paper">
      <div className="mx-auto flex min-h-[70vh] max-w-md flex-col justify-center px-5 py-16 text-center">
        <div className="rounded-3xl border border-borderc bg-surface p-8 shadow-sm">
          {result.ok ? (
            <>
              <h1 className="text-2xl font-black text-ink">Je bent uitgeschreven</h1>
            ...
            <>
              <h1 className="text-2xl font-black text-ink">Hm, dat lukte niet</h1>
              <p className="mt-3 text-sm text-ink/60">{result.error}</p>
            </>
          )}
