        ...
        <div className="rounded-3xl border border-borderc bg-surface p-8 shadow-sm">
          ...
          {sent ? (
            ...
            <form onSubmit={submit} className="mt-5 space-y-3">
              <p className="text-sm text-ink/60">Vul je e-mail in en we sturen je een herstellink.</p>
              <input
                type="email"
                required
          ...
          <Link href="/login" className="mt-5 block text-center text-sm font-semibold text-ink/50 hover:text-ink">
            ← Terug naar inloggen
          </Link>
        </div>
      </div>
