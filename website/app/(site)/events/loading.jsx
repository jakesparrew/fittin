      ...
      <div className="animate-pulse">
        <section className="bg-brand px-5 py-16">
          <div className="mx-auto max-w-4xl space-y-4">
            <div className="h-3 w-28 rounded bg-surface/20" />
            <div className="h-10 w-80 max-w-full rounded bg-surface/25" />
            <div className="h-4 w-full max-w-2xl rounded bg-surface/15" />
          </div>
        </section>
        ...
        <div className="mx-auto max-w-4xl px-5 py-14">
          <div className="h-40 rounded-3xl border border-borderc bg-surface" />
        </div>
      </div>
    </main>
  );
