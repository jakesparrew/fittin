...
export default function OfflinePage() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-paper px-6 text-center">
      <div className="w-full max-w-md rounded-3xl border border-borderc bg-surface p-8">
        <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-full bg-accent/15 text-2xl">📡</div>
        <h1 className="mt-5 text-2xl font-black text-ink">Je bent offline</h1>
        ...
        <div className="mt-6 rounded-2xl bg-accent/10 p-4 text-left">
          <p className="text-sm font-black text-ink">Sta je aan de deur?</p>
        ...
        <p className="mt-4 text-xs text-ink/45">Nood? Bel altijd eerst 112. Vragen: info@fittin.be</p>
      </div>
    </main>
  );
}
